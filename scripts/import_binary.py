...
filename = "/Users/louis/experiments/data/15-10-07/naturalscene.h5"
...
print("/n/train/stimulus")
train_stimulus = np.asarray(f["train"]["stimulus"])
print("data shape:", train_stimulus.shape)